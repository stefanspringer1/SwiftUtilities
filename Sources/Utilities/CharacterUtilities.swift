    ...
    public init() {
        ...
        do {
            let codePoints = UCCodePoints(
                ...
                // ---- single codepoints:
                [
                    0x0027, 0x003E, 0x0060, 0x00A0, 0x00BD, 0x01B5, 0x01F5, 0x0401, 0x0451, 0x1E9E, 0x2013, 0x201C, 0x202F, 0x0237, 0x2041,
                    0x2043, 0x204F, 0x2057, 0x2102, 0x2105, 0x2124, 0x21A6, 0x21DD, 0x21F5, 0x221A, 0x225C, 0x2300, 0x2336, 0x233D, 0x233F,
                    0x237C, 0x2396, 0x23E2, 0x2423, 0x24C8, 0x2580, 0x2584, 0x2588, 0x25AA, 0x25B1, 0x25EC, 0x25EF, 0x260E, 0x2640, 0x2642,
                    0x2660, 0x2663, 0x266A, 0x2713, 0x2717, 0x2720, 0x2736, 0x27C2, 0x27FC, 0x27FF, 0x2916, 0x2933, 0x2945, 0x299A, 0x29B9,
                    0x29C9, 0x29DA, 0x29EB, 0x29F6, 0x2A04, 0x2A06, 0x2A40, 0x2A50, 0x2A66, 0x2A6A, 0x2AE4, 0x2AFD, 0xE905, 0xFE68,
                    0x1D49C,0x1D4A2, 0x1D4BB, 0x1D546,
                ]
            )
